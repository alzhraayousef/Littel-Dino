var DividProcessDiv=document.createElement("div")
DividProcessDiv.setAttribute("id","DividProcessDiv")


    document.body.appendChild(DividProcessDiv);
    ...
    DividProcessDiv.appendChild(navDiv)


    sectionDiv=document.createElement("div")
    sectionDiv.setAttribute("id","sectionDiv")

    DividProcessDiv.appendChild(sectionDiv);
