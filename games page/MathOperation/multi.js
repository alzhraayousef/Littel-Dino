var MultiProcessDiv=document.createElement("div")
MultiProcessDiv.setAttribute("id","MultiProcessDiv")


    document.body.appendChild(MultiProcessDiv);
    ...
    MultiProcessDiv.appendChild(navDiv)


    sectionDiv=document.createElement("div")
    sectionDiv.setAttribute("id","sectionDiv")

    MultiProcessDiv.appendChild(sectionDiv);
